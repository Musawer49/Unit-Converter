...
if choice == 1:
    ...
    if choose == "A":
        ...
        ask_user = int(input("Enter the weight in Kilograms: "))
        Pound = ask_user * 2.2046
        print(f"The weight is {Pound} Pounds")
    elif choose == "B":
        print("You have selected Pounds")
        ask_user = int(input("Enter the weight in Pounds: "))
    ...
    if choose == "A":
        ...
        ask_user = int(input("Enter the temperature in Fahrenheit: "))
        Celsius = (ask_user - 32) / 1.8
        print(f"The temperature is {Celsius} Celsius")
    elif choose == "B":
        print("You have selected Celsius")
        ask_user = int(input("Enter the temperature in Celsius: "))
